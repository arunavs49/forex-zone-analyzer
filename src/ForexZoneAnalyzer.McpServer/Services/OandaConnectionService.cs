...
public class OandaConnectionService : IOandaConnectionService
{
    ...
    private async Task<string> GetOandaTokenAsync(CancellationToken cancellationToken)
    {
        ...
        throw new InvalidOperationException(
            "No OANDA API token configured. Set KeyVault:Uri and KeyVault:OandaTokenSecretName, " +
            "or Oanda:ApiToken for local development.");
    }
}
